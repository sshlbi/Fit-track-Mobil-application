...
Week getWeek9Data() {
  return const Week(
    ...
    isDeload: true,
    description: 'Foundation Block - Deload Week',
    notes:
        'Second deload week. RPE 7-9. Reduce intensity to recover before final phase.',
    workoutDays: [
      // DAY 1: UPPER STRENGTH FOCUS
      WorkoutDay(
        id: 'w9_upper_strength',
