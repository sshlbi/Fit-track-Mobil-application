...
Week getWeek8Data() {
  return const Week(
    ...
    isDeload: false,
    description: 'Foundation Block - Week 8',
    notes:
        'Continue full intensity. Last set to failure (RPE 10) with intensity techniques.',
    workoutDays: [
      // DAY 1: UPPER STRENGTH FOCUS
      WorkoutDay(
        id: 'w8_upper_strength',
