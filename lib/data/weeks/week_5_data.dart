...
Week getWeek5Data() {
  return const Week(
    ...
    notes:
        'Deload week. RPE 7-9. Reduce intensity to recover before next phase.',
    workoutDays: [
      // DAY 1: UPPER STRENGTH FOCUS
      WorkoutDay(
        id: 'w5_upper_strength',
