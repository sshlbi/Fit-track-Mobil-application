...
Week getWeek2Data() {
  return const Week(
    ...
    isDeload: false,
    description: 'Foundation Block - Week 2',
    notes:
        'Last set to failure (RPE 10) on all exercises. Intensity techniques introduced.',
    workoutDays: [
      // DAY 1: UPPER STRENGTH FOCUS
      WorkoutDay(
        id: 'w2_upper_strength',
