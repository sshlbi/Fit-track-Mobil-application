...
Week getWeek6Data() {
  return const Week(
    ...
    isDeload: false,
    description: 'Foundation Block - Week 6',
    notes:
        'Back to full intensity. Last set to failure (RPE 10) with intensity techniques.',
    workoutDays: [
      // DAY 1: UPPER STRENGTH FOCUS
      WorkoutDay(
        id: 'w6_upper_strength',
